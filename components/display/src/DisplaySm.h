...
public:
    ...
    enum class DISPLAY_STATE_HistoryId: uint8_t
    {
        ...
        CONNECTING_STATE = 2,
        RUNNING_STATE = 3,
        IMPROV_AWAITING_AUTH_STATE_UI = 4,
        IMPROV_STARTED_STATE = 5,
        IMPROV_AUTHORIZED_STATE_UI = 6,
        IMPROV_PROVISIONED_STATE_UI = 7,
        IMPROV_PROVISIONING_STATE_UI = 8,
        SHOW_CONNECTED_STATE = 9,
        SHOW_CONNECTING_STATE = 10,
    };
